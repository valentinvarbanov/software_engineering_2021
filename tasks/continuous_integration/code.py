...
verification_data = [
    ...
    },
    {
        ...
        text_key: 'AI Dungeon is a free-to-play single-player \
        and multiplayer text adventure game which uses artificial\
        intelligence to generate content. It allows players to\
        create and share their own custom adventure settings.\
        The game\'s first version was made available on Colab in May 2019,\
        and its second version (initially called AI Dungeon 2) was released\
        online and for iOS and Android in December 2019.\
        The AI model was then upgraded in July 2020.',
    }
]
...
for hw in get_homeworks():
    ...
    for data_set in verification_data:
        ...
        decrypted_output = os.popen(
            f'echo "{text}" | python encrypt.py --key "{key}" >\
            encrypted && cat encrypted | python {hw}/decrypt.py').read()
